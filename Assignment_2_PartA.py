...
if __name__ == '__main__':
    ...
    # M = np.genfromtxt('./SPECT.train', missing_values=0, skip_header=0, delimiter=',', dtype=int)
    y_train = M[:, 0]
    x_train = M[:, 1:]

    # Load the test data
    # M = np.genfromtxt('./SPECT.test', missing_values=0, skip_header=0, delimiter=',', dtype=int)
    ...
    decision_tree = id3(x_train, y_train, attribute_value_pairs, max_depth=3)
